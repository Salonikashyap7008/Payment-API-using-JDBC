...
document.getElementById("rzp-button1").addEventListener("click", function() {
    ...
    var options = {
        ...
        "amount": amount * 100, // Convert amount to cents (Razorpay expects amount in smallest currency unit)
        "currency": "INR",
        "name": "Saloni",
        ...
        "prefill": {
            "name": username,
            "email": username, // Leave empty to let user fill in during checkout
            "contact": phone, // You can optionally collect this from the form too
        },
        "notes": {
